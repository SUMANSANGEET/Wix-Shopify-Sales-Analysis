...
[![Live App](https://img.shields.io/badge/Live%20App-Streamlit-FF4B4B?style=flat-square&logo=streamlit&logoColor=white)](https://wix-shopify-sales-analysis-tw8dnzyuqy46fzhhwtecrm.streamlit.app/)

> **P Suman Sangeet** · Data Analyst & AI Intern, LabMentix · PGDM in Big Data Analytics

**🔗 Live demo: [wix-shopify-sales-analysis.streamlit.app](https://wix-shopify-sales-analysis-tw8dnzyuqy46fzhhwtecrm.streamlit.app/)**
...
**👉 Try it live: [https://wix-shopify-sales-analysis-tw8dnzyuqy46fzhhwtecrm.streamlit.app/](https://wix-shopify-sales-analysis-tw8dnzyuqy46fzhhwtecrm.streamlit.app/)**

Screenshots of the running Streamlit companion app — same KPIs and logic as the Power BI report — included here so the dashboard is reviewable straight from GitHub, or click through to explore it live and filter the data yourself.
...
**Fastest option — no install needed:** open the [live app](https://wix-shopify-sales-analysis-tw8dnzyuqy46fzhhwtecrm.streamlit.app/) directly in your browser.
